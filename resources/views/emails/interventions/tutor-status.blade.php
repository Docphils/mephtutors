...
<head>
    ...
    <title>Intervention Tutor Notification</title>
</head>
...
<body style="margin:0;padding:24px;background:#e2e8f0;font-family:Arial,Helvetica,sans-serif;color:#0f172a;">
    <div
        ...
        <div style="padding:22px 24px;">
            <p style="margin-top:0;">Hello {{ $tutor->tutorProfile?->fullName ?? ($tutor->name ?? 'Tutor') }},</p>
            ...
            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:10px;padding:14px;">
                ...
                @if (!empty($context['payment_status']))
                    <p style="margin:0;"><strong>Tutor Payout Status:</strong>
                        {{ strtoupper((string) $context['payment_status']) }}</p>
                @endif
            </div>
