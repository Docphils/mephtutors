...
<body style="font-family:Arial,Helvetica,sans-serif;background:#f8fafc;color:#0f172a;padding:24px;">
    <div
        ...
        <div style="padding:20px;">
            ...
            <p style="margin:0 0 14px;">Your payment has gone through and your spot is secured.</p>
            ...
            <p style="margin:16px 0 0;">We'll follow up shortly with session details and anything you need to prepare
                before the first class.</p>
        </div>
    </div>
</body>
