<div class="p-6 max-w-7xl mx-auto space-y-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-cyan-600 rounded-3xl p-8 text-white shadow-lg shadow-cyan-200 flex flex-col justify-center">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('tutor.programme-assignments') }}" wire:navigate
                    class="flex items-center justify-between p-3 bg-white/10 rounded-2xl hover:bg-white/20 transition-all group">
                    <span class="font-bold text-sm">Intervention Assignments</span>
                    <i class="fa-solid fa-arrow-right text-xs group-hover:translate-x-1 transition-transform"></i>
                </a>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div class="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all">
            <div class="w-12 h-12 bg-violet-50 rounded-2xl flex items-center justify-center text-violet-600 mb-4">
                <i class="fa-solid fa-graduation-cap text-xl"></i>
            </div>
            <h4 class="text-slate-400 font-bold text-xs uppercase tracking-wider mb-1">Active Interventions</h4>
            <div class="flex items-end justify-between">
    ...
    <div class="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-100 flex items-center justify-between">
            <h4 class="font-black text-slate-800">Recent Intervention Assignments</h4>
            <a href="{{ route('tutor.programme-assignments') }}" wire:navigate class="text-xs font-bold text-cyan-600">Open</a>
        </div>
        <div class="p-6 space-y-3">
            ...
            @empty
                <p class="text-sm text-slate-500">No intervention assignments yet.</p>
            @endforelse
        </div>
    </div>
</div>
