<div class="container mx-auto p-6 bg-white border border-slate-200 shadow-sm rounded-sm text-slate-800">
    ...
    <p class="mb-4">
        MephEd values your privacy and is committed to protecting your personal information.
        This Privacy Policy outlines our practices regarding the collection, use, and protection of your data.
    </p>
    ...
    <p class="mb-4">
        We do not sell, trade, or rent your personal information to others. We may share your data with:
    </p>
    <ul class="list-disc ml-6 mb-4">
    ...
    <p class="mb-4">
        MephEd<br>
        Email: <a href="mailto:info@mephed.ng" class="text-cyan-600">info@mephed.ng</a><br>
        Phone: <a href="tel:+2347062599737" class="text-cyan-600">+234(0)7062599737, +234(0)8062869170</a>
    </p>
</div>
