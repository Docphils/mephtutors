<div class="space-y-0">
    ...
    <main class="container mx-auto py-10 px-6">
        ...
        <section class="py-12">
            <div class="max-w-5xl mx-auto px-4">
                ...
                <p class="text-center text-slate-600 mt-2">Simple steps to find great tutors and learning programs.</p>
        ...
        <section class="py-12 bg-slate-100 rounded-2xl">
                ...
                <div x-data="{ open: null }" class="mt-8 space-y-3">
                    <div class="bg-white rounded-lg shadow">
                        ...
                        <div x-show="open === 1" x-collapse class="px-6 pb-4 text-slate-600">
                            Browse programs or request a tutor via our booking form. Choose schedule and lesson format, then confirm payment.
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow">
                        ...
                        <div x-show="open === 4" x-collapse class="px-6 pb-4 text-slate-600">
                            Yes, we provide club instructors, EdTech strategy and bespoke programs. Use the partner options on our platform to get started.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-20 bg-gradient-to-r from-slate-100 to-cyan-50 rounded-2xl">
    ...
    <section class="px-8 sm:px-20 py-20 bg-gradient-to-r from-slate-900 to-cyan-900 text-white">
    ...
    <section class="py-20 bg-gradient-to-r from-slate-100 to-cyan-50">
