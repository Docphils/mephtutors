            ...
            <div class="min-w-full divide-y divide-gray-200">
                <div class="bg-gray-50">
                    <div class="grid grid-cols-8 pr-4">
                        <div
                            class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase divacking-wider col-span-2">
                            Username</div>
                        <div
                            class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider col-span-3">
                            Email</div>
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-xl relative max-h-[90vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-4 mb-4 items-center w-full">
                    <h3 class="col-span-3 relative w-full text-2xl font-semibold text-cyan-700 text-center">Tutor
                        Profile Details</h3>
                    <p class="relative border"> <img
                            src="{{ asset('storage/' . $selectedClient->userProfile->image) }}"
                            alt="{{ $selectedClient->name }}'s image" class="object-cover h-auto"> </p>
                </div>
