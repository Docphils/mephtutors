    ...
    <div class="container mx-auto grid grid-cols-3 items-center px-6">
        ...
        <div :class="{'block': open, 'hidden': !open}" class="hidden sm:hidden">
         ...
         <div class="-me-2 flex items-center sm:hidden">
            <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-cyan-100 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100  focus:text-gray-500  transition duration-150 ease-in-out">
