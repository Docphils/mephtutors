...
<body class="bg-cyan-300 font-sans leading-normal tracking-normal h-screen">
    ...
    <div class="relative overflow-hidden bg-cyan-800 pt-16 pb-32 space-y-24">
        <div class="">
            ...
            <p class="text-lg text-gray-50 text-center max-w-2xl mx-auto mt-4">At MephEd, we offer a variety of services
                to help you excel in your education and personal development. Explore our offerings below.</p>
        </div>
        <div class="relative">
                    ...
                    <div>
                            ...
                            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M3 9.75L12 3l9 6.75v7.5a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 17.25v-7.5z" />
                        ...
                        <div class="mt-6">
                            ...
                            <p class="mt-4 text-lg text-gray-300">
                                Experience personalized home tutoring for every subject and level. Enjoy customized
                                lessons designed just for you to enhance your learning and achieve your academic and
                                career goals.
                            </p>
                            <div class="mt-6">
                                <a wire:navigate
                        ...
                        <div>
                            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M8 12l-2 2m0-4l2 2m8-2l-2 2m0-4l2 2M6 8h12M6 16h12" />
                                </svg>
                            </span>
                        </div>
                        <div class="mt-6">
                            ...
                            <p class="mt-4 text-lg text-gray-300">
                                Learn coding from basics to advanced levels with our expert tutors. Whether you're
                                starting out or looking to master complex concepts, our personalized guidance will help
                                you succeed.
                            </p>
                            <div class="mt-6">
                                <a wire:navigate
                        ...
                        <div>
                            <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    class="h-8 w-8 text-white">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 2.25v3M7.5 4.5v1.5m9-1.5v1.5M3.75 12.75h16.5m-1.5-2.25a5.25 5.25 0 01-5.25 5.25 5.25 5.25 0 01-5.25-5.25m5.25 5.25v4.5m-2.25-4.5h4.5m-7.5 0h1.5m-1.5 0v4.5m9-4.5h-1.5m1.5 0v4.5M8.25 9.75h1.5M8.25 11.25h1.5M14.25 9.75h1.5M14.25 11.25h1.5M12 9.75h.008v.008H12V9.75z" />
                                </svg>
                            </span>
                        </div>
                        <div class="mt-6">
                            ...
                            <p class="mt-4 text-lg text-gray-300">
                                Whether you want to render an impactful community service for shaping the future, or you
                                want your school to stand out through co-curricular activities, MephEd is here for you.
                            </p>
                            <div class="mt-6">
                                <a wire:navigate
                                    class="inline-flex rounded-lg bg-pink-600 px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1 ring-pink-600 hover:bg-pink-700 hover:ring-pink-700"
                ...
                <div class="mt-12 sm:mt-16 lg:mt-0">
                    <div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                        <img loading="lazy" width="646" height="485"
                            class="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                            style="color:transparent" src="/images/robotics.jpg">
                    </div>
                </div>
            </div>
        </div>
