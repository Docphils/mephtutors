...
<div x-data="{ open: false }" x-init="{
    window.addEventListener('open-modal-{{ $id }}', () => open = true);
    window.addEventListener('close-modal-{{ $id }}', () => open = false);
}" x-show="open"
    class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
    <div class="fixed inset-0 bg-black/50" @click="open = false"></div>

    <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-3xl mx-auto z-50 overflow-hidden">
